  ...
  return (
    <Link href={getArticlePath(article)} className="block transition-all hover:scale-[1.01] active:scale-[0.99] group">
      <div className="bg-white p-6 md:p-8 rounded-[28px] border border-gray-200 shadow-sm transition-all hover:border-gray-300 hover:shadow-md">
        ...
        <div className="flex flex-col-reverse md:flex-row md:items-start justify-between gap-5 md:gap-10">
          ...
          {coverImage && (
            <div className="relative w-full md:w-[240px] aspect-[16/10] md:aspect-[16/10] md:h-auto shrink-0 self-start">
              <Image
                src={coverImage}
                alt={title}
                fill
