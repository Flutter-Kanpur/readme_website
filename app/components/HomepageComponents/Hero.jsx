...
export default function Hero() {
  return (
    <section className="w-full min-h-0 md:min-h-[70vh] pt-12 md:pt-32 pb-6 md:pb-24 px-6 flex flex-col items-center justify-start md:justify-center text-center relative max-w-7xl mx-auto opacity-0 animate-[fade-in_0.5s_ease-out_forwards]">
